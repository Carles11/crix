    ...
    <div>
      ...
      <White_block>
        ...
        <Article>
          ...
          applications. All the code we write for you is personally optimized to
          your necessities, and it is very scalable. That way, if you start with
          a small project that covers your needs for now and you want to make it
          grow when the time is right, it will nicely grow. We don´t use any
          templates or web constructing systems. We just Javascript code from
          scratch for you.
        </Article>
      </White_block>
      <Bg_pic_block>
        ...
        <Article_w>
          Besides coding you a tailor made website, we offer you server
          maintenance and domain buy. Leave us the job of maintaining your
          server and let us take care of the domain you like. We update all our
          servers regularly and take care that your website is always on-line.
        </Article_w>
      </Bg_pic_block>
      <White_block>
        ...
        <Article>
          ...
          need in your site and we will give you that fair price you have in
          mind.
        </Article>
      </White_block>
      <QuotationForm />
